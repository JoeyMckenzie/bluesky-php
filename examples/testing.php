...
$feedGenerator = $client->app()->feed()->getFeedGenerator('at://did:plc:z72i7hdynmk6r22z27h6tvur/app.bsky.feed.generator/whats-hot');
var_dump($feedGenerator);

$feedGenerators = $client->app()->feed()->getFeedGenerators([
    'at://did:plc:z72i7hdynmk6r22z27h6tvur/app.bsky.feed.generator/whats-hot',
    'at://did:plc:jfhpnnst6flqway4eaeqzj2a/app.bsky.feed.generator/for-science',
]);
var_dump($feedGenerators);

$likes = $client->app()->feed()->getLikes('at://did:plc:dg5diaehkfj3c66spqqvf7dp/app.bsky.feed.post/3lavri2jxhc24');
var_dump($likes);

$listFeed = $client->app()->feed()->getListFeed('at://did:plc:3ond7kebhvszgzsqo5llyipd/app.bsky.graph.list/3lawjh5t6pa2f');
var_dump($listFeed);

$postThread = $client->app()->feed()->getPostThread('at://coulb.com/app.bsky.feed.post/3lawmrlrrjk23');
var_dump($postThread);

$posts = $client->app()->feed()->getPosts([
...
$quotes = $client->app()->feed()->getQuotes('at://did:plc:epouc7jtubjdv64mum274hv2/app.bsky.feed.post/3layv3ui35c27');
var_dump($quotes);

$suggestedFeeds = $client->app()->feed()->getSuggestedFeeds();
var_dump($suggestedFeeds);

$timeline = $client->app()->feed()->getTimeline();
var_dump($timeline);

$searchPosts = $client->app()->feed()->searchPosts('php', sort: 'latest', since: Carbon::yesterday());
