...
use function Tests\Fixtures\Bsky\searchPosts;
...
describe('search posts', function (): void {
    it('can search posts', function (): void {
        ...
        // Act
        $result = $client->bsky()->feed()->searchPosts('php');
    ...
    it('can search posts with a cursor', function (): void {
        ...
        // Act
        $result = $client->bsky()->feed()->searchPosts('php', cursor: 'test-cursor');
    ...
    it('can search posts with a sort', function (): void {
        ...
        // Act
        $result = $client->bsky()->feed()->searchPosts('php', sort: 'latest');
    ...
    it('can search posts with a since date', function (): void {
        ...
        // Act
        $result = $client->bsky()->feed()->searchPosts('php', since: $since);
    ...
    it('can search posts with an until date', function (): void {
        ...
        // Act
        $result = $client->bsky()->feed()->searchPosts('php', until: $until);
    ...
    it('can search posts with a mention', function (): void {
        ...
        // Act
        $result = $client->bsky()->feed()->searchPosts('php', mentions: 'user-did');
    ...
    it('can search posts with an author', function (): void {
        ...
        // Act
        $result = $client->bsky()->feed()->searchPosts('php', author: 'user-did');
    ...
    it('can search posts with a lang', function (): void {
        ...
        // Act
        $result = $client->bsky()->feed()->searchPosts('php', lang: 'en');
    ...
    it('can search posts with a domain', function (): void {
        ...
        // Act
        $result = $client->bsky()->feed()->searchPosts('php', domain: 'joeymckenzie.tech');
    ...
    it('can search posts with a url', function (): void {
        ...
        // Act
        $result = $client->bsky()->feed()->searchPosts('php', url: 'joeymckenzie.tech');
    ...
    it('can search posts with tags', function (): void {
        ...
        // Act
        $result = $client->bsky()->feed()->searchPosts('php', tag: ['tag-1', 'tag-2']);
